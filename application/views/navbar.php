                    ...
                    <nav class="navbar" role="navigation">
                        <input type="checkbox" id="css3menu-switcher" class="c3m-switch-input">
                         <ul id="css3menu1" class="topmenu">
                            ...
                            <li class="topmenu">
                                ...
                                <ul>
                                    ...
                                    <li class="">
                                        ...
                                        <a id="A10" href="<?php echo base_url();?>index.php/welcome/enquiryform
                                            " target="_blank" style="font-size: 16px;">Enquiry Form</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="topmenu">
                                ...
                                <ul>
                                    <li class="subfirst">
                                        ...
                                        <a id="A13" href="<?php echo base_url();?>index.php/welcome/photo_gallery" target="_blank" style="font-size: 16px;">Photo Gallery</a>
                                    </li>
                                    <li class="">
                            ...
                            <li class="topmenu">
                                <input type="hidden" name="Menu8" id="Hidden19" value="11">
                                <a id="A19" href="<?php echo base_url();?>index.php/welcome/contact_us" target="_self"><span style="font-size: 18px;">&nbsp;&nbsp;&nbsp;Contact us&nbsp;</span></a>
                            </li>
