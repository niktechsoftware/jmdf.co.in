...
(function($) {
        ...
        setWidgetCollapse: function() {
            ...
            if (window.matchMedia('(max-width: 767px)').matches) {
                $('footer.footer-collapse-able aside.widget').each(function() {
                    ...
                    if (content != null && content != 'undefined') $(content).hide();
                    $(title).off();
        ...
        processWidthAudioPlayer: function() {
            setTimeout(function() {
                $('.jp-audio .jp-type-single').each(function() {
                    var _width = $(this).outerWidth() - $('.jp-controls', this).outerWidth() - parseInt($('.jp-controls', this).css('margin-right').replace('px', ''), 10) -
                        25;
            ...
            $(document).on('click', 'a[data-like-comment="true"]:not(".liked")', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.cookie('g5plus_comment_liked', comment_liked, {
                            path: '/'
                        });
                        $this.addClass('liked');
    ...
    G5Plus.woocommerce = {
        ...
        singleProductImage: function($productImageWrap) {
            ...
            function syncPosition(value) {
                var current = value;
                $thumb.find(".slick-slide").removeClass("synced").eq(current).addClass("synced");
                center(current);
            }
    ...
    G5Plus.header = {
        ...
        canvasMenu: function() {
            ...
            $(document).on('click', function(event) {
                if (($(event.target).closest('nav.canvas-menu-wrapper').length == 0) && ($(event.target).closest('.canvas-menu-toggle')).length == 0) {
