$(document).ready(function () {
    ...
    $.ajax({
        type: "POST",
        url: "main.aspx/placementgalleryname",
        data: "{'id':'" + id + "'}",
    ...
    $('#gallery_sec1').delegate('.view_more_button', 'click', function () {
        ...
        window.location.href = "placement-gallery-detaild41d.html?" + id + "";
    ...
    $('.binddata1').delegate('.view_more_button', 'click', function () {
        ...
        window.parent.location.href = "placement-gallery-detaild41d.html?" + id + "";
    ...
    $.ajax({
        type: "POST",
        url: "main.aspx/placementgallerydata",
